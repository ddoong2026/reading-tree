...
다음 세 가지를 포함해서 3~4문장으로 다정하게 피드백을 작성해줘:
...
3. 학생의 글에 대해 0점에서 100점 사이로 점수를 매기고, 피드백 맨 마지막 줄에 "[SCORE: 80]"과 같은 형식으로 점수를 출력해. 평가 기준을 아주 관대하게 적용해서, 욕설이나 완전히 의미 없는 글(예: 'ㅋㅋㅋ', '아무말')이 아니라면 무조건 70점 이상을 줘. 짧게라도 책 내용이나 느낀 점이 있다면 통과시켜줘. 만약 70점 미만이라면 어떤 점을 고쳐서 다시 제출해야 할지 다정하게 알려줘.
